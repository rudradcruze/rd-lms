...
class RoleController {
  async createRole(req, res) {
    ...
    return res.status(201).json(
      new ApiResponse(201, role, ROLE_MESSAGES.ROLE_CREATED)
    );
  }
  ...
  async updateRole(req, res) {
    ...
    return res.status(200).json(
      new ApiResponse(200, role, ROLE_MESSAGES.ROLE_UPDATED)
    );
  }
  ...
  async getAllRoles(req, res) {
    ...
    const result = await RoleService.getAllRoles(parseInt(page), parseInt(limit));
    return res.status(200).json(
  ...
  async deleteRole(req, res) {
    ...
    return res.status(200).json(
      new ApiResponse(200, null, ROLE_MESSAGES.ROLE_DELETED)
    );
  }
  ...
  async revokePermissionFromRole(req, res) {
    ...
    return res.status(200).json(
      new ApiResponse(200, null, ROLE_MESSAGES.PERMISSION_REVOKED)
    );
  }
}
